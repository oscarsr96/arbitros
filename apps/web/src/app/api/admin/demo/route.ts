...
const CLUB_NAMES = [
  ...
  'Fuentelarreyna',
  'Liceo Francés',
  // Clubes grandes de la Comunidad de Madrid
  'Uros de Rivas',
  'CB Getafe',
  'Veritas Pozuelo',
  'Basket Torrejón',
  ...
  'Basket Aranjuez',
  'Colmenar Viejo CB',
  'Baloncesto San Fernando',
  'Parla Basket',
  'Villa de Valdemoro',
  // Clubes de Madrid capital
  'Zentro Basket',
  'Distrito Olímpico',
  'CB Moratalaz',
  'CB Chamberí',
  ...
  'CB Batres',
  'Baloncesto Cubas',
  'CB Torrejón de la Calzada',
  // Clubes de la periferia norte
  'CB Alcobendas',
  'Baloncesto Sanse',
  'CB Algete',
  'Paracuellos Basket',
  ...
  'CB Daganzo',
  'Baloncesto Ajalvir',
  // Clubes de la periferia este
  'CB Mejorada',
  'Baloncesto Velilla',
  'CB Loeches',
  'Basket Nuevo Baztán',
  'Baloncesto Campo Real',
  'CB Villalbilla',
  // Clubes de la sierra / periferia oeste
  'CB Collado Villalba',
  'Baloncesto Galapagar',
  'CB El Escorial',
  'Basket Guadarrama',
  ...
  'Villanueva Basket',
  'Baloncesto Brunete',
  'CB Villaviciosa de Odón',
  'Baloncesto Arroyomolinos',
  // Clubes adicionales reales FBM
  'CB Mirasierra',
  'Baloncesto Aluche',
  'CB Vallecas',
  'Basket San Blas',
  'Baloncesto Vicálvaro',
  'CB Barajas',
  'Baloncesto Fuencarral',
  'CB Moncloa',
  'Basket Prosperidad',
  'CB Chamartín',
  'Baloncesto Salamanca',
  'CB Arganzuela',
  'Basket Puente de Vallecas',
  'CB San Cristóbal',
  'Baloncesto Orcasitas',
  'CB Entrevías',
  'Basket Palomeras',
  'CB PAU Carabanchel',
  'Baloncesto Ensanche de Vallecas',
  'CB Sanchinarro',
  'Basket Las Tablas',
  'Baloncesto Montecarmelo',
  'CB Valdebebas',
  'Basket Arroyo del Fresno',
  'CB Mirasierra Norte',
  'Baloncesto El Pardo',
  'CB Peñagrande',
  'Basket Aravaca',
  'Baloncesto Somosaguas',
  'CB Húmera',
]
